...
(function (angular) {
    ...
    var multipleDatePicker = function () {
            return {
                ...
                '<div  ng-if="disableAllMonths"    class="text-center picker-navigate picker-navigate-left-arrow" ng-class="{\'disabled\':disableBackButton}" ng-click="changeMonth($event, disableBackButton, -1)">&lt;</div>' +
                '<div class="text-center picker-month"   ng-if="disableAllMonths"   >  ' +
                ...
                '</div>' +
                '<div  ng-if="disableAllMonths"    class="text-center picker-navigate picker-navigate-right-arrow" ng-class="{\'disabled\':disableNextButton}" ng-click="changeMonth($event, disableNextButton, 1)">&gt;</div>' +
                '</div>' +
                '<div class="picker-days-week-row"  ng-if="disableAllWeek" >' + 
                ...
                link: function (scope) {
                   ...
                   // scope.disableAllMonths = true;
                   // scope.disableAllWeek= true;
                    scope.daysOfWeek = getDaysOfWeek();
